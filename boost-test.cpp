...
{
	cout << "Test Case 1: Addition Testing of " << x << "+" << y << "\n";
	Rational result = x + y;
	return result;
}
...
{
	cout << "Test Case 2: Subtraction Testing of " << x << "-" << y << "\n";
...
{
	cout << "Test Case 3: Multiplication Testing of " << x << "*" << y << "\n";
...
{
	cout << "Test Case 4: Division Testing of " << x << "/" << y << "\n";

	Rational result = x / y;
	return result;
}*/

BOOST_AUTO_TEST_SUITE(mathematics)

/*BOOST_AUTO_TEST_CASE(test_case_addition)
{
	BOOST_CHECK_EQUAL(addition(1,1), 2);
}*/
